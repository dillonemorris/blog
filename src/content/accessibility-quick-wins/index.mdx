...
![Google chrom dev tools](./a11y-dev-tools.png)

This is what you see when you use the element inspector and hover over an element in Chrome. In the bottom half of this popover you get a nice Accessibility indicator. As you can see, the headline I'm hovering over meets the WCAG standard with a contrast ratio of 13.5.
