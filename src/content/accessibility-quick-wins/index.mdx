...
However, just using your eye isn't good enough because it doesn't take into account others who see the world differently than you. You might vbe able to read the one on the right just fine.
...
In Chrome for example, open the developer tools (Cmd + Option + i) and make sure you have the element inspector selected:
